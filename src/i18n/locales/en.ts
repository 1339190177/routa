...
const en: TranslationDictionary = {
  ...
  workspace: {
    ...
    titleSaved: "Title updated",
    dangerZone: "Danger Zone",
    dangerZoneDescription: "These actions are irreversible. Proceed with caution.",
    archiveWorkspace: "Archive Workspace",
    deleteWorkspace: "Delete Workspace",
    cannotDeleteLast: "You cannot delete the last workspace.",
    confirmDeleteTitle: "Delete Workspace?",
    confirmDeleteMessage: "This will permanently delete this workspace and all associated data.",
    cascadeInfo: "{count} linked codebase(s) will be removed.",
    cascadeNote: "All sessions, agents, and tasks will be permanently deleted.",
