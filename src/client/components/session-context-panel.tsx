...
import { SquarePen, Trash2, Zap, ArrowUp, ArrowDown, FileText, GitBranch, ArrowUpDown, ScrollText } from "lucide-react";
        ...
        <div className="border-b border-slate-100 dark:border-slate-800">
          <div className="flex items-center justify-between gap-2 px-3 py-2">
            <div className="flex items-center gap-1.5">
              <ScrollText className="h-3.5 w-3.5 text-slate-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} />
            ...
            <Link
              ...
              className="rounded-md border border-slate-200 px-2 py-1 text-[10px] font-medium text-slate-500 transition-colors hover:bg-slate-50 hover:text-slate-700 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800 dark:hover:text-slate-100"
            >
              {t.sessions.showAll}
            </Link>
          </div>
          ...
          <div className="px-3 pb-2 space-y-1">
            {recentSessions.map((session) => (
              <SessionRow
                ...
                session={session}
                highlighted={session.sessionId === focusedSessionId}
                icon={<Zap className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} />}
