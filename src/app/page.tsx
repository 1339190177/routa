        ...
        titleBarRight={(
          <div className="flex items-center gap-1.5">
            ...
            <button
              ...
              className="inline-flex h-8 w-8 items-center justify-center rounded-xl text-slate-500 transition-colors hover:bg-white/80 hover:text-slate-900 dark:text-slate-400 dark:hover:bg-white/8 dark:hover:text-slate-100"
            ...
            <div className="rounded-full border border-black/6 bg-white/70 px-2 py-1 dark:border-white/8 dark:bg-white/6">
